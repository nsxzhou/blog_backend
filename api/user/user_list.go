...
func (u *User) UserList(c *gin.Context) {
	...
	list, count, err := search_ser.ComList(models.UserModel{}, search_ser.Option{
	...
	global.Log.Info("用户列表成功", zap.String("method", c.Request.Method), zap.String("path", c.Request.URL.Path))
